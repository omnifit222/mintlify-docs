---
title: "Integrate  OmnifitAI with GoHigh Level"
description: "This is the guide for integrating  OmnifitAI with GoHighLevel Integration"
---
...
- **Streamlined Lead Management** – Capture and sync  OmnifitAI leads directly into GoHighLevel’s CRM for centralized tracking.
- **Automated Follow-Ups** – Trigger SMS, email, and voicemail campaigns based on chatbot interactions without manual intervention.
- **Unified Customer Journey** – Combine GoHighLevel funnels and  OmnifitAI conversations for a seamless engagement flow.
- **Smart Workflow Automation** – Use  OmnifitAI chat events to initiate GoHighLevel workflows and nurture sequences.

---

## **Steps for Integration:**

#### **Step 1. Navigating to GHL in  OmnifitAI:**

1. Log into your  OmnifitAI account, and go to your desired bot. Click on “**Third-party Apps Integrations**” option to go to all available 3rd Party Integrations page.
...
3. **Step 4: Set Up Mapping Parameters**
   ...
   Now that the connection between  OmnifitAI and GoHighLevel (GHL) CRM is established, you need to map parameters (fields) of GHL CRM to the user responses from  OmnifitAI's chatbot.
   1. You can use the **\+Add Parameters** button to add more fields.

      <Info>
        **Example Mapping Process**
        1. **Select a Question from  OmnifitAI Chat Flow**
...
1. As a result, this mapping will enable the integration to **send the user's response from  OmnifitAI to GoHighLevel's CRM fields**, storing it correctly in the contact records.
