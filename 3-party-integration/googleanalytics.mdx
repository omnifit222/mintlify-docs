---
title: "Integrate  OmnifitAI with Google Analytics"
description: "This page contains step by step information on how you can integrate the Google Analytics with the  OmnifitAI."
---

#### **Integration of Google Analytics with  OmnifitAI**

Google Analytics is a powerful tool to measure and analyze user interactions, such as the number of clicks and views, on your chatbot. Integrating Google Analytics with your  OmnifitAI chatbot enables you to track these metrics and optimize performance.

Follow these steps to integrate Google Analytics with  OmnifitAI:

**Step 1: Log in to  OmnifitAI**

1. Navigate to your [ OmnifitAI account](https://www. OmnifitAI.com/).
...
To connect Google Analytics to your  OmnifitAI account, you need the Measurement ID from your Google Analytics account. Follow these steps to get it:
...
**Step 4: Connect Google Analytics to  OmnifitAI**

1. Go back to the  OmnifitAI integration page where you clicked **Connect** for Google Analytics.
