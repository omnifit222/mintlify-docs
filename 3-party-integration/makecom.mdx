...
### **How to use  OmnifitAI as Trigger**
 ...
 8. \
    You can now click on the "\+" icon in canvas and search for  OmnifitAI in the search bar.
...
### **How to use Action in  OmnifitAI**
 ...
 8. \
    Set up connection by providing the **API key and BotID **from  OmnifitAI as explained above.
