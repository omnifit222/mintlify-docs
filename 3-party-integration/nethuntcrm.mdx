...
to complete integration of  OmnifitAI with NetHunt.
...
a. Now, as connection of the  OmnifitAI and NetHunt CRM is established, you need

to map **parameters (fields) of NetHunt CRM** to the user response of the  OmnifitAI question.
...
As a result, this mapping will enable integration to send the user's response from
 ...
 OmnifitAI to the NetHunt CRM’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to NetHunt CRM fields.
