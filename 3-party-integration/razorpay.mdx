---
title: "Integrate  OmnifitAI with Razorpay"
description: "This page contains al the necessary information on how you can interate the Razorpay with Botepenguin"
---

### **Prerequisites**

To successfully integrate Razorpay with  OmnifitAI, you will need:

- A ** OmnifitAI** account.
- A **Razorpay** account.
- A **WhatsApp bot**

This integration enables your WhatsApp bot created on  OmnifitAI to collect payments via Razorpay.

#### **Step 1: Login to  OmnifitAI and Select WhatsApp Bot**

1. Go to [ OmnifitAI](https://www. OmnifitAI.com/) and log into your account.
...
To connect Razorpay with  OmnifitAI, you need the **Client ID** and **Client Secret** from your Razorpay account.
...
4. Go back to  OmnifitAI and copy the **Webhook URL** from the integration settings.
...
1. Navigate back to your  OmnifitAI bot editor.
2. \
...
Your  OmnifitAI WhatsApp bot is now successfully integrated with Razorpay. You can collect payments seamlessly and track payment events through the configured webhooks. This integration ensures a smooth payment experience for your users directly through WhatsApp.   