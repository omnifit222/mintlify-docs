...
integration of  OmnifitAI with Shipway.
...
a. Now, as connection of the  OmnifitAI and Shipway is established, you need

to map **parameters (fields) of Shipway** to the user response of the  OmnifitAI question.
...
As a result, this mapping will enable integration to send the user's response from
 ...
 OmnifitAI to the Shipway’s **Name **field in the leads. Similarly, in order for integration to work properly, you will require to map all other questions/ components of your Bot to Shipway fields.
