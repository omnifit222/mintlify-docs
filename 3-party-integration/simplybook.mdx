---
title: "Integrate  OmnifitAI with SimplyBook"
description: "This page contains the stepwise tutorial for the integration of SimplyBook with  OmnifitAI."
---

**\
Access Your  OmnifitAI Account**

- Log in to your  OmnifitAI account and select the bot you wish to integrate with SimplyBook.

**\
Navigate to Third-Party App Integrations**

- Go to the "Third-Party App Integrations" section in your  OmnifitAI account.
