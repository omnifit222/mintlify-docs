---
title: "Integrate  OmnifitAI with WooCommerce"
description: "This page contains the stepwise tutorial for WooCommerce Integration with  OmnifitAI."
---
...
### **Step 1 of 4: Login to your  OmnifitAI Account and Select Application to Integrate:**

1. Login to your  OmnifitAI account. Now, select and click the WhatsApp chatbot you want to integrate with WooCommerce. Click on the “**Third-party Apps Integration”.**
2. \
...
3. Add API URL: “https://api.v7. OmnifitAI.com/whatsapp/woo-commerce/{{phoneNumberId}}”
...
### **Step 3 of 4: Edit the integration configurations in  OmnifitAI**
...
When an order is shipped,  OmnifitAI can automatically notify customers with a **shipment confirmation message**.
...
Once you have established a connection between ** OmnifitAI** and **the WooCommerce website, you are ready** for your first test lead. You can test your integration setup by creating a dummy lead on the bot. This lead should appear in your  OmnifitAI dashboard as well as in the WhatsApp chatbot sent messages.
