...
public class ReplaceOmnifitAIFixes {
    public static void main(String[] args) {
        ...
        try (Stream<Path> pathStream = Files.walk(folderPath)) {
            List<Path> allTextFiles = pathStream
                    ...
                    .filter(ReplaceOmnifitAIFixes::isTextFile)
    ...
    private static boolean processFile(Path filePath) {
        try {
            ...
            String updated = content
                    .replace("_ OmnifitAI", "_OmnifitAI")
                    .replace("how- OmnifitAI-works", "how-botpenguin-works");
