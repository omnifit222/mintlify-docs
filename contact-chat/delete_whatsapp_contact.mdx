...
This API endpoint allows you to update the status of users in your  OmnifitAI application.

**Endpoint URL:** `https://api.v7. OmnifitAI.com/inbox/users/status-update`
...
```
curl 'https://api.v7. OmnifitAI.com/inbox/users/status-update' \
  -X 'PUT' \
