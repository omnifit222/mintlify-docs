...
To use the  OmnifitAI APIs, You need to insure that you have following details with you.

A. **UUID** - You can get the UUID from the local web session storage as show in the image below:

![251 Website Contacts Meta Data  OmnifitAI Resource C 1 Pn](/images/api-references/website-contact-metadata/251.website_contacts__meta_data__OmnifitAI_resource_c-1.png)
...
https://page. OmnifitAI.com/BotId/CustomerId
...
<script id=" OmnifitAI-messenger-widget" src="https://cdn. OmnifitAI.com/ OmnifitAI.js" defer>BotId,CustomerId</script>
...
### **Create a lead in the  OmnifitAI**
...
`PUT` `https://api.v7. OmnifitAI.com/inbox/direct/lead`
...
`GET` `https://api.v7. OmnifitAI.com/inbox/direct/chats`
    ...
    "data": [
        {
            ...
            "lastMessage": {
                ...
                "by": "bot",
                "text": "Welcome to  OmnifitAI. I am here to help you."
            },
...
If you have any questions, you can look into our repository of FAQs, most likely, you will find your answer here, If not, write us at [support@ OmnifitAI.com](mailto:support@ OmnifitAI.com).