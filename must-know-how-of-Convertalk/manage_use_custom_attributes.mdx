...
Custom attributes in  OmnifitAI allow you to personalize user interactions and collect specific data. Follow these steps to create and manage custom attributes:

### **Step 1: Navigate to the  OmnifitAI dashboard.**

- Log in to your  OmnifitAI account and access the dashboard.
...
- From the dropdown menu, select "Account/Settings."
  ...
  ![234 Manage Use Custom Attributes  OmnifitAI Resource 1 Pn](/images/platform-guidelines-training/manage-use-custom-attribute/234.manage__use_custom_attributes__OmnifitAI_resource-1.png)
...
- Here, you'll find a list of all your custom attributes. You can edit, delete, bulk delete, and add new custom attributes from this tab.
  ...
  ![234 Manage Use Custom Attributes  OmnifitAI Resource 2 Pn](/images/platform-guidelines-training/manage-use-custom-attribute/234.manage__use_custom_attributes__OmnifitAI_resource-2.png)

### **Step 4: Create a New Custom Attribute.**

- To add a new attribute, click the "Add Attribute" button.

  ![234 Manage Use Custom Attributes  OmnifitAI Resource 3 Pn](/images/platform-guidelines-training/manage-use-custom-attribute/234.manage__use_custom_attributes__OmnifitAI_resource-3.png)
...
And that's it\! You've successfully created a custom attribute in  OmnifitAI. This attribute can now be used to personalize interactions, segment users, and enhance the overall chatbot experience.