...
```
https://api.v7. OmnifitAI.com/whatsapp-automation/wa/templates?apiKey=*API KEY*
```
...
```
curl --location --request GET 'https://api.v7. OmnifitAI.com/whatsapp-automation/wa/templates?apiKey=*API KEY*' \\
